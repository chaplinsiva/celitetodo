...
export default function DeleteModal({ isOpen, onClose, onConfirm }) {
  ...
  return (
    ...
    >
      <div className="bg-surface-modal border border-border-hairline rounded-lg w-full max-w-[350px] p-7 shadow-[0_30px_60px_rgba(0,0,0,0.8)] animate-modal-in relative mx-auto text-center">
        ...
        <h2 className="font-heading text-lg font-semibold text-text-primary mb-2">Delete Task?</h2>
        ...
        <div className="flex justify-center gap-3 mt-6 w-full">
          <button
            className="flex-1 bg-surface-input border border-border-hairline text-text-primary rounded-full px-5 py-2.5 font-heading text-sm font-medium cursor-pointer transition-all hover:bg-themeHover active:scale-98"
            onClick={onClose}
          >
            Cancel
          </button>
